...
class SwapStaysController extends GetxController {
  ...
  showDatePickerBottomSheet(BuildContext context){
    showModalBottomSheet(
        ...
        isScrollControlled: true,
        constraints: BoxConstraints(maxHeight: 560.px),
        builder: (BuildContext context) {
          return StatefulBuilder(
              builder: (BuildContext context,StateSetter setState){
                return Container(
                  ...
                  child: Column(
                    ...
                    children:[
                      Row(
                        children: [
                          Icon(Icons.calendar_month_sharp,color: text2Color,size: 30.px,),
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration:BoxDecoration(
                                  ...
                                  color: calendarIndex.value==0?primary3Color:Colors.white10
                              ),
                              child: Text(StringConstants.exactDates,
                                style: MyTextStyle.customStyle(fontFamily: 'Lora',
                                    color: calendarIndex.value==0?Colors.lightBlueAccent:primary3Color,
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color:calendarIndex.value==1?primary3Color:Colors.white10 ,
                                  borderRadius: BorderRadius.circular(100.px),
                              ),
                              child: Center(
                                child: Text(StringConstants.plusOneDay,
                                  style: MyTextStyle.customStyle(fontSize: 16.px,fontFamily: 'Lora',
                                      color:calendarIndex.value==1?Colors.lightBlueAccent:primary3Color,
                                  ),
                                ),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: Container(
                              height: 40.px,width: 80.px,
                              decoration: BoxDecoration(
                                color:calendarIndex.value==2?primary3Color:Colors.white10 ,
                                borderRadius: BorderRadius.circular(100.px),
                              ),
                              child: Center(
                                child: Text(StringConstants.plusTwoDay,
                                  style: MyTextStyle.customStyle(fontSize: 16.px,fontFamily: 'Lora',
                                    color:calendarIndex.value==2?Colors.lightBlueAccent:primary3Color,
                                  ),
                                ),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(StringConstants.next,
                                style: MyTextStyle.customStyle(fontFamily: 'Lora',color: text2Color,fontSize: 18.px,fontWeight: FontWeight.w700),
                              ),
                            ),
                          ),
                        ],
