...
class FeaturesSpaceHaveView extends GetView<FeaturesSpaceHaveController> {
  const FeaturesSpaceHaveView({super.key});
  @override
                  ...
                  children: [
                    ListTile(
                        ...
                        title:Padding(
                          ...
                          child: Center(
                            child: CommonWidgets.typingText(text: 'Essentials',style: MyTextStyle.customStyle(
                    ...
                    Wrap(
                        ...
                        children:List.generate(controller.featuresList.length, (int index){
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color:controller.featuresList[index]['isSelected']?primary3Color: primary3Color.withOpacity(0.2),
                                boxShadow: [
                                  BoxShadow(
                                    offset:controller.featuresList[index]['isSelected']?const Offset(0,4):const Offset(0,0),
                                    color:controller.featuresList[index]['isSelected']?const Color(0xFF4A99ED) :blackColor.withOpacity(0.15),
                                    blurRadius:controller.featuresList[index]['isSelected']?24: 15,spreadRadius: 0
                                  )
                                ]
                              ),
                              child: controller.featuresList[index]['isSelected']?
                                  CommonWidgets.gradientText(text:controller.featuresList[index]['name'],
                                      style: MyTextStyle.customStyle(fontSize: 14.px,fontFamily: 'Lora',fontWeight: FontWeight.w700
                                      )):
                              CommonWidgets.typingText(text:controller.featuresList[index]['name'],
