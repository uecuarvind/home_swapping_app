...
class TravelerProfileFavoritePlaceView
    extends GetView<TravelerProfileFavoritePlaceController> {
  const TravelerProfileFavoritePlaceView({super.key});
  @override
                ...
                children: [
                  ListTile(
                      ...
                      title:Padding(
                        ...
                        child: Center(
                          child: CommonWidgets.typingText(text: 'favorite places',style: MyTextStyle.customStyle(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 10.px,),
                                    Text(controller.dreamList[index]['place']??'',style: controller.dreamList[index]['status']?
