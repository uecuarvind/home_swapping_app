            ...
            children: [
                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: CommonWidgets.appImagesView(
                                imagePath:'assets/images/img_traveler.png',
                                width: 90.px,
                                height: 90.px,
                              borderRadius: 45.px
                            ),
              ...
              ListTile(
                ...
                title: Text(StringConstants.speaks,style: MyTextStyle.customStyle(fontFamily: 'Lora',fontWeight: FontWeight.w500,fontSize: 14,
                    color:const Color(0xFF878787)),),
                subtitle: Text('English, Spanish, Italiano',style: MyTextStyle.customStyle(fontFamily: 'Lora',fontWeight: FontWeight.w600,fontSize: 14,
                    color:const Color(0xFF606060)),),
              ),
              ListTile(
                contentPadding: EdgeInsets.symmetric(horizontal: 10.px,vertical: 0.px),
